defmodule ProgramOps do
  ...
  defp do_op(3, instruction_pointer, program) do
    ...
    {List.replace_at(program, position_to_update, 5), instruction_pointer + 2}
  end
  ...
  defp do_op(5, instruction_pointer, program) do
    {first_value, second_value} = get_both_values(program, instruction_pointer)

    {program, jump_if_true(first_value, second_value, instruction_pointer)}
  end

  defp do_op(105, instruction_pointer, program) do
    first_value = Enum.at(program, instruction_pointer + 1)
    second_value = get_second_value(program, instruction_pointer)
  ...
  defp do_op(1105, instruction_pointer, program) do
    first_value = Enum.at(program, instruction_pointer + 1)
    second_value = Enum.at(program, instruction_pointer + 2)
  ...
  defp do_op(1005, instruction_pointer, program) do
    first_value = get_first_value(program, instruction_pointer)
    second_value = Enum.at(program, instruction_pointer + 2)
  ...
  defp do_op(6, instruction_pointer, program) do
    {first_value, second_value} = get_both_values(program, instruction_pointer)

    {program, jump_if_false(first_value, second_value, instruction_pointer)}
  end

  defp do_op(106, instruction_pointer, program) do
    first_value = Enum.at(program, instruction_pointer + 1)
    second_value = get_second_value(program, instruction_pointer)
  ...
  defp do_op(1106, instruction_pointer, program) do
    first_value = Enum.at(program, instruction_pointer + 1)
    second_value = Enum.at(program, instruction_pointer + 2)
  ...
  defp do_op(1006, instruction_pointer, program) do
    first_value = get_first_value(program, instruction_pointer)
    second_value = Enum.at(program, instruction_pointer + 2)
  ...
  defp do_op(7, instruction_pointer, program) do
    {first_value, second_value} = get_both_values(program, instruction_pointer)
    position_to_update = Enum.at(program, instruction_pointer + 3)

    {List.replace_at(program, position_to_update, less_than(first_value, second_value)),
     instruction_pointer + 4}
  end

  defp do_op(107, instruction_pointer, program) do
    first_value = Enum.at(program, instruction_pointer + 1)
    second_value = get_second_value(program, instruction_pointer)
    position_to_update = Enum.at(program, instruction_pointer + 3)
  ...
  defp do_op(1107, instruction_pointer, program) do
    first_value = Enum.at(program, instruction_pointer + 1)
    second_value = Enum.at(program, instruction_pointer + 2)
    position_to_update = Enum.at(program, instruction_pointer + 3)
  ...
  defp do_op(1007, instruction_pointer, program) do
    first_value = get_first_value(program, instruction_pointer)
    second_value = Enum.at(program, instruction_pointer + 2)
    position_to_update = Enum.at(program, instruction_pointer + 3)
  ...
  defp do_op(8, instruction_pointer, program) do
    {first_value, second_value} = get_both_values(program, instruction_pointer)
    position_to_update = Enum.at(program, instruction_pointer + 3)

    {List.replace_at(program, position_to_update, equals(first_value, second_value)),
     instruction_pointer + 4}
  end

  defp do_op(108, instruction_pointer, program) do
    first_value = Enum.at(program, instruction_pointer + 1)
    second_value = get_second_value(program, instruction_pointer)
    position_to_update = Enum.at(program, instruction_pointer + 3)
  ...
  defp do_op(1108, instruction_pointer, program) do
    first_value = Enum.at(program, instruction_pointer + 1)
    second_value = Enum.at(program, instruction_pointer + 2)
    position_to_update = Enum.at(program, instruction_pointer + 3)
  ...
  defp do_op(1008, instruction_pointer, program) do
    first_value = get_first_value(program, instruction_pointer)
    second_value = Enum.at(program, instruction_pointer + 2)
    position_to_update = Enum.at(program, instruction_pointer + 3)
  ...
  defp less_than(first, second) do
    if first < second do
      1
    else
      0
  ...
  defp jump_if_true(first, second, instruction_pointer) do
    if first != 0 do
      second
    else
  ...
  defp jump_if_false(first, second, instruction_pointer) do
    if first == 0 do
      second
    else
      instruction_pointer + 3
